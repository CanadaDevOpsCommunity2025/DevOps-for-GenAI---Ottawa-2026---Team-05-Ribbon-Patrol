...
| **P-06** | **AI transparency** (Declare where GenAI/coding tools were used) | **MET** | [README.md](../README.md#-ai-usage--assisted-tooling-disclosure), [docs/AI_GOVERNANCE.md](AI_GOVERNANCE.md#1-system--model-overview) | Disclosed usage of Gemini 2.5 Flash, Gemini 2.5 Pro, Imagen 3, Gemini Live API, and AI-assisted pair programming during development. |
