...
* [Roadmap Overview](kubepet/roadmap/README.md)
  * [Phase 1: Core API & state completeness](kubepet/roadmap/phase-1-core-api-and-state-completeness/README.md)
    ...
    * [1.3 Live workspace Git status scanner](kubepet/roadmap/phase-1-core-api-and-state-completeness/1.3-live-workspace-git-status-scanner.md)
  * [Phase 2: UI, visual and ergonomic polish](kubepet/roadmap/phase-2-ui-visual-and-ergonomic-polish/README.md)
    * [2.1 90-second guided demo bar](kubepet/roadmap/phase-2-ui-visual-and-ergonomic-polish/2.1-90-second-guided-demo-bar.md)
    * [2.2 Interactive Git DAG topology visualizer](kubepet/roadmap/phase-2-ui-visual-and-ergonomic-polish/2.2-interactive-git-dag-topology-visualizer.md)
    * [2.3 Syntax-colored diff highlighting](kubepet/roadmap/phase-2-ui-visual-and-ergonomic-polish/2.3-syntax-colored-diff-highlighting.md)
    * [2.4 Keyboard shortcuts and audio feedback](kubepet/roadmap/phase-2-ui-visual-and-ergonomic-polish/2.4-keyboard-shortcuts-and-audio-feedback.md)
  * [Phase 3: Voice and multimodal hardening](kubepet/roadmap/phase-3-voice-and-multimodal-hardening/README.md)
